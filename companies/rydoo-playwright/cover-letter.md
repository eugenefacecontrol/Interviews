Dear Rydoo Hiring Team,

I am applying for the Senior Automation QA Engineer (Playwright) role. I am a Senior QA Automation Engineer / SDET with 7+ years of experience across UI/API automation, CI/CD-integrated testing, framework improvement, and environment-aware quality work.

What makes this role interesting to me is its focus on senior playwright automation, product qa, maintainable ui/api coverage, release feedback. My strongest value is practical automation: I improve test frameworks, reduce noisy feedback, build useful diagnostics, and connect automated checks with release confidence rather than treating tests as isolated scripts.
