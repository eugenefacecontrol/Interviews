# Link Group (AI-assisted QA) - QA Engineer AI-assisted Cover Letter

Dear Link Group (AI-assisted QA) team,

I am interested in the QA Engineer AI-assisted role. I bring 7+ years of QA automation and SDET-style experience across UI/API automation, CI/CD-integrated testing, framework improvement, defect triage, environment-aware debugging and practical automation tooling.

The strongest overlap with this role is around AI-assisted QA workflows, Playwright/Cypress/Pytest automation, web app user flows, CI/CD and UAT support. My recent work includes improving an API automation framework, increasing automated coverage without increasing runtime, reducing noisy test logs from around 1.5 GB to 11 MB per run, and supporting Playwright/TypeScript automation direction for maintainable UI checks.
