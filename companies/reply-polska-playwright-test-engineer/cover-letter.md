# Reply Polska - Mid/Senior Test Engineer with Playwright Cover Letter

Dear Reply Polska team,

I am interested in the Mid/Senior Test Engineer with Playwright role. I bring 7+ years of QA automation and SDET-style experience across UI/API automation, CI/CD-integrated testing, framework improvement, defect triage, environment-aware debugging and practical automation tooling.

The strongest overlap with this role is around manual and automated testing, Playwright, test strategy, requirements analysis, reporting and team collaboration. My recent work includes improving an API automation framework, increasing automated coverage without increasing runtime, reducing noisy test logs from around 1.5 GB to 11 MB per run, and supporting Playwright/TypeScript automation direction for maintainable UI checks.
