# Raiffeisen Tech Poland - Quality Assurance Engineer Cover Letter

Dear Raiffeisen Tech Poland team,

I am interested in the Quality Assurance Engineer role. I bring 7+ years of QA automation and SDET-style experience across UI/API automation, CI/CD-integrated testing, framework improvement, defect triage, environment-aware debugging and practical automation tooling.

The strongest overlap with this role is around banking QA role with automation potential; exact stack needs verification from LinkedIn/full JD. My recent work includes improving an API automation framework, increasing automated coverage without increasing runtime, reducing noisy test logs from around 1.5 GB to 11 MB per run, and supporting Playwright/TypeScript automation direction for maintainable UI checks.
