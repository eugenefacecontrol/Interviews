# State Street - QA Automation Engineer Cover Letter

Dear State Street team,
...
The role's stack and expectations around Playwright, Java, Selenium, REST, API, CI/CD are close to the kind of quality work I want to continue building. The financial context is relevant because reliable regression coverage, traceability and careful edge-case handling matter in systems where defects can be costly.
