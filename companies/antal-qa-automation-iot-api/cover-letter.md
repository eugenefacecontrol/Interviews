# Antal (IoT API) - QA Automation Engineer Cover Letter

Dear Antal (IoT API) team,

I am interested in the QA Automation Engineer role. I bring 7+ years of QA automation and SDET-style experience across UI/API automation, CI/CD-integrated testing, framework improvement, defect triage, environment-aware debugging and practical automation tooling.

The strongest overlap with this role is around API automation for IoT services, TypeScript/Node.js test work, databases, Docker and CI/CD pipelines. My recent work includes improving an API automation framework, increasing automated coverage without increasing runtime, reducing noisy test logs from around 1.5 GB to 11 MB per run, and supporting Playwright/TypeScript automation direction for maintainable UI checks.
