# EPAM Systems (Python/Azure) - Test Automation Engineer with Python and Azure Cloud Cover Letter

Dear EPAM Systems (Python/Azure) team,

I am interested in the Test Automation Engineer with Python and Azure Cloud role. I bring 7+ years of QA automation and SDET-style experience across UI/API automation, CI/CD-integrated testing, framework improvement, defect triage, environment-aware debugging and practical automation tooling.

The strongest overlap with this role is around Python automation, API testing, Selenium/web validation, CI/CD and cloud-aware quality engineering. My recent work includes improving an API automation framework, increasing automated coverage without increasing runtime, reducing noisy test logs from around 1.5 GB to 11 MB per run, and supporting Playwright/TypeScript automation direction for maintainable UI checks.
