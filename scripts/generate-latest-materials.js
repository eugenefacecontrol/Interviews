...
function coverLetter(job) {
  return [
    ...
    '',
    'What makes this role interesting to me is its focus on ' + job.focus.toLowerCase() + ' My strongest value is practical automation: I improve test frameworks, reduce noisy feedback, build useful diagnostics, and connect automated checks with release confidence rather than treating tests as isolated scripts.',
    '',
